...
def search(query,pages):
    ...
    content_html_pages.append(r.content)
    ...
    while counter < pages:
        ...
        #Random Sleep Function Just an Experiment Add longer time if it is getting blocked
        time.sleep(round(random.uniform(0.62, 1.85), 2)) #
        counter = counter + 1
    return links , content_html_pages